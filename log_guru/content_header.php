<header class="main-header">
  <!-- Logo -->
  <div class="logo">
<span class="logo-mini"><img src="../aset/foto/lkp.jpg" class="img-circle" alt="Logo" height="50" width="50"></span>
<span class="logo-lg"><b>LKP UTAMA JAYA</b></span>
</div>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <p>Welcome To LKP UTAMA JAYA</p>
            </li>
            <!-- Menu Footer-->
            <li class="user-footer">
               <div class="pull-left">
                <a href="ubah_pass.php" class="btn btn-primary">Ubah Password <i class="fa fa-lock"></i></a>
              </div>
