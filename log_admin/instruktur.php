        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index_admin.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        <li class="active"><a href="instruktur.php"><i class="fa fa-user"></i><span>Instruktur</span></a></li>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="instruktur_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>Kode Intruktur</label>
									<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-id-card"></i>
										</div>
										<input name="kode_p" type="text" class="form-control" placeholder="Kode Instruktur" required="" />
									</div>
							</div>
							<div class="form-group">
								<label>Instruktur</label>
									<div class="input-group">
										...
										<input name="nama_pem" type="text" class="form-control" placeholder="Nama Instruktur" required=""/>
									</div>
							</div>
							<div class="form-group">
