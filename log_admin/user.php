							...
							<div class="form-group">
								<label>Id User</label>
									<div class="input-group">
										...
										<input name="id" type="text" class="form-control" placeholder="Masukkan Id User" required="" />
									</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Foto</label>
									<div class="input-group date">
										...
										<input name="foto" type="file" class="form-control" placeholder="Masukkan Password" required="">
									</div>
							</div>
